        ...
        <div className="text-right space-y-6">
          <div className="space-y-2 relative">
            ...
            <div className="relative z-10">
              <h1 className="text-8xl font-primary font-light tracking-wider text-foreground">
                MATT
              </h1>
              <h2 className="text-8xl font-primary font-light tracking-wider text-foreground">
                CARLA
              </h2>
            </div>
